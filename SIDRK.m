function u1 = SIDRK(Spara,tau,a,t0,u0,g)
...
force = g(X,Y,t0+c1*tau);
F1 = fft2(u0)/tau/a11 + fft2(force(1:M,1:M));
u_temp1 = u0;
while tol > Tol
...
force = g(X,Y,t0+c2*tau);
F1 = fft2(u0+tau*a21*k1)/tau/a22 + fft2(force(1:M,1:M));
u_temp1 = u0;
while tol > Tol
    fftu_temp = fft2(u_temp1(1:M,1:M));
    gradient_x = ifft2(Dx.*fftu_temp);
